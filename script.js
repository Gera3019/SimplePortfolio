...
ScrollReveal().reveal(".scroll-para", { origin: "top" });

ScrollReveal().reveal(".scroll-img", { origin: "top" });

ScrollReveal().reveal(".scroll-info", { origin: "bottom" });
ScrollReveal().reveal(".scroll-fact", { origin: "top" });

ScrollReveal().reveal(".scroll-skill", { origin: "top" });
ScrollReveal().reveal(".scroll-resume", { origin: "top" });

ScrollReveal().reveal(".scroll-card", { origin: "top", scale: 0 });

ScrollReveal().reveal(".servicerow", { origin: "top"});

ScrollReveal().reveal(".servicebox", { origin: "top",interval:100});

ScrollReveal().reveal(".scroll-contact", { origin: "top"});
